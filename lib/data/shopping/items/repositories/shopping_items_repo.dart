...
class ShoppingListItemsRepo {
  ...
  ShoppingItem addItem(FirestoreTransaction tx, ShoppingItemRawData data) {
  ...
  void updateItem(FirestoreTransaction tx, ShoppingItem item, ShoppingItemRawData updatedData) {
    final fs = ref.read(firestoreProvider);
  ...
  void deleteItems(FirestoreTransaction tx, List<ShoppingItem> items) {
    final fs = ref.read(firestoreProvider);
    final user = ref.read(userAuthProvider);
