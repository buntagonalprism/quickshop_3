...
class ListRepo {
  ...
  void updateListModified(FirestoreTransaction tx, String listId, DateTime modifiedAt) {
    final user = ref.read(userAuthProvider);
    final fs = ref.read(firestoreProvider);
  ...
  void incrementListItemCount(FirestoreTransaction tx, String listId, int delta, DateTime modifiedAt) {
    final user = ref.read(userAuthProvider);
    final fs = ref.read(firestoreProvider);
    final listDoc = fs.doc('lists/$listId');
    tx.batch.update(listDoc, {
