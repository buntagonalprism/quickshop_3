...
mixin _$ListSummary {
 ...
 String get id; String get name;/// The ID of the user who created the list
 String get ownerId;/// List of user IDs who can edit the list, including the owner
 List<String> get editorIds;/// List of user details of users who can edit the list, including the owner
 List<UserAuth> get editors;/// Number of items in the list
 int get itemCount;/// When the list was last modified by a specific user, in milliseconds since the epoch.
 Map<String, int> get lastModified; ListType get listType;
...
@useResult
$Res call({
 String id, String name, String ownerId, List<String> editorIds, List<UserAuth> editors, int itemCount, Map<String, int> lastModified, ListType listType
});
...
as List<UserAuth>,itemCount: null == itemCount ? _self.itemCount : itemCount // ignore: cast_nullable_to_non_nullable
as int,lastModified: null == lastModified ? _self.lastModified : lastModified // ignore: cast_nullable_to_non_nullable
as Map<String, int>,listType: null == listType ? _self.listType : listType // ignore: cast_nullable_to_non_nullable
as ListType,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String name,  String ownerId,  List<String> editorIds,  List<UserAuth> editors,  int itemCount,  Map<String, int> lastModified,  ListType listType)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ListSummary() when $default != null:
return $default(_that.id,_that.name,_that.ownerId,_that.editorIds,_that.editors,_that.itemCount,_that.lastModified,_that.listType);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String name,  String ownerId,  List<String> editorIds,  List<UserAuth> editors,  int itemCount,  Map<String, int> lastModified,  ListType listType)  $default,) {final _that = this;
switch (_that) {
case _ListSummary():
return $default(_that.id,_that.name,_that.ownerId,_that.editorIds,_that.editors,_that.itemCount,_that.lastModified,_that.listType);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String name,  String ownerId,  List<String> editorIds,  List<UserAuth> editors,  int itemCount,  Map<String, int> lastModified,  ListType listType)?  $default,) {final _that = this;
switch (_that) {
case _ListSummary() when $default != null:
return $default(_that.id,_that.name,_that.ownerId,_that.editorIds,_that.editors,_that.itemCount,_that.lastModified,_that.listType);case _:
  return null;
...
/// When the list was last modified by a specific user, in milliseconds since the epoch.
@override Map<String, int> get lastModified {
...
/// Create a copy of ListSummary
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = null,Object? ownerId = null,Object? editorIds = null,Object? editors = null,Object? itemCount = null,Object? lastModified = null,Object? listType = null,}) {
...
as List<UserAuth>,itemCount: null == itemCount ? _self.itemCount : itemCount // ignore: cast_nullable_to_non_nullable
as int,lastModified: null == lastModified ? _self._lastModified : lastModified // ignore: cast_nullable_to_non_nullable
as Map<String, int>,listType: null == listType ? _self.listType : listType // ignore: cast_nullable_to_non_nullable
as ListType,
  ));
}
