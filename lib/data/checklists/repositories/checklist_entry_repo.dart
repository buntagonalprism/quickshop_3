...
class ChecklistEntryRepo {
  ...
  void removeItem(FirestoreTransaction tx, ChecklistItem item) {
    final fs = ref.read(firestoreProvider);
  ...
  void removeHeading(FirestoreTransaction tx, ChecklistHeading heading) {
    final fs = ref.read(firestoreProvider);
  ...
  void editItem(FirestoreTransaction tx, ChecklistItem item, String newName) {
    final fs = ref.read(firestoreProvider);
    final itemDoc = fs.doc('lists/$listId/items/${item.id}');
  ...
  void editHeading(FirestoreTransaction tx, ChecklistHeading heading, String newName) {
    final fs = ref.read(firestoreProvider);
    final headingDoc = fs.doc('lists/$listId/items/${heading.id}');
