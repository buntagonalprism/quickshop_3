...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CategorySelectorItem);
}
...
$CategorySelectorItemCopyWith(CategorySelectorItem _, $Res Function(CategorySelectorItem) __);
}
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( _NewCategory value)?  newCategory,TResult Function( _Suggestion value)?  suggestion,TResult Function( _History value)?  history,TResult Function( _List value)?  list,required TResult orElse(),}){
final _that = this;
switch (_that) {
case _NewCategory() when newCategory != null:
return newCategory(_that);case _Suggestion() when suggestion != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( _NewCategory value)  newCategory,required TResult Function( _Suggestion value)  suggestion,required TResult Function( _History value)  history,required TResult Function( _List value)  list,}){
final _that = this;
switch (_that) {
case _NewCategory():
return newCategory(_that);case _Suggestion():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( _NewCategory value)?  newCategory,TResult? Function( _Suggestion value)?  suggestion,TResult? Function( _History value)?  history,TResult? Function( _List value)?  list,}){
final _that = this;
switch (_that) {
case _NewCategory() when newCategory != null:
return newCategory(_that);case _Suggestion() when suggestion != null:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  newCategory,TResult Function( String name)?  suggestion,TResult Function( String name)?  history,TResult Function( String name)?  list,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _NewCategory() when newCategory != null:
return newCategory();case _Suggestion() when suggestion != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  newCategory,required TResult Function( String name)  suggestion,required TResult Function( String name)  history,required TResult Function( String name)  list,}) {final _that = this;
switch (_that) {
case _NewCategory():
return newCategory();case _Suggestion():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  newCategory,TResult? Function( String name)?  suggestion,TResult? Function( String name)?  history,TResult? Function( String name)?  list,}) {final _that = this;
switch (_that) {
case _NewCategory() when newCategory != null:
return newCategory();case _Suggestion() when suggestion != null:
return suggestion(_that.name);case _History() when history != null:
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _NewCategory);
}
