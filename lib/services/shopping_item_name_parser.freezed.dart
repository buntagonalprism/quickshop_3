...
mixin _$ParsedShoppingItem {
  ...
  $ParsedShoppingItemCopyWith<ParsedShoppingItem> get copyWith =>
      _$ParsedShoppingItemCopyWithImpl<ParsedShoppingItem>(
          this as ParsedShoppingItem, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ParsedShoppingItem &&
...
abstract mixin class $ParsedShoppingItemCopyWith<$Res> {
  factory $ParsedShoppingItemCopyWith(
          ParsedShoppingItem value, $Res Function(ParsedShoppingItem) _then) =
      _$ParsedShoppingItemCopyWithImpl;
  @useResult
...
extension ParsedShoppingItemPatterns on ParsedShoppingItem {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ParsedShoppingItem value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String product, String quantity)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
...
class _ParsedShoppingItem extends ParsedShoppingItem {
  const _ParsedShoppingItem({required this.product, required this.quantity})
      : super._();
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ParsedShoppingItemCopyWith<_ParsedShoppingItem> get copyWith =>
      __$ParsedShoppingItemCopyWithImpl<_ParsedShoppingItem>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _ParsedShoppingItem &&
            (identical(other.product, product) || other.product == product) &&
            (identical(other.quantity, quantity) ||
                other.quantity == quantity));
  }
...
/// @nodoc
abstract mixin class _$ParsedShoppingItemCopyWith<$Res>
    implements $ParsedShoppingItemCopyWith<$Res> {
  factory _$ParsedShoppingItemCopyWith(
          _ParsedShoppingItem value, $Res Function(_ParsedShoppingItem) _then) =
      __$ParsedShoppingItemCopyWithImpl;
  @override
  @useResult
  $Res call({String product, String quantity});
}
