...
mixin _$HttpResult {
  ...
  $HttpResultCopyWith<HttpResult> get copyWith =>
      _$HttpResultCopyWithImpl<HttpResult>(this as HttpResult, _$identity);
...
abstract mixin class $HttpResultCopyWith<$Res> {
  factory $HttpResultCopyWith(
          HttpResult value, $Res Function(HttpResult) _then) =
      _$HttpResultCopyWithImpl;
  @useResult
  $Res call({String uri});
}
...
extension HttpResultPatterns on HttpResult {
  ...
  TResult maybeMap<TResult extends Object?>({
    ...
    switch (_that) {
      ...
      case HttpResultError() when error != null:
        return error(_that);
      case _:
        return orElse();
    }
  ...
  TResult maybeWhen<TResult extends Object?>({
    ...
    switch (_that) {
      case HttpResultSuccess() when success != null:
        return success(_that.uri, _that.response, _that.statusCode);
      case HttpResultError() when error != null:
        return error(_that.uri, _that.error);
      case _:
        return orElse();
    }
  }
...
class HttpResultSuccess extends HttpResult {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $HttpResultSuccessCopyWith<HttpResultSuccess> get copyWith =>
      _$HttpResultSuccessCopyWithImpl<HttpResultSuccess>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is HttpResultSuccess &&
            (identical(other.uri, uri) || other.uri == uri) &&
...
/// @nodoc
abstract mixin class $HttpResultSuccessCopyWith<$Res>
    implements $HttpResultCopyWith<$Res> {
  factory $HttpResultSuccessCopyWith(
          HttpResultSuccess value, $Res Function(HttpResultSuccess) _then) =
      _$HttpResultSuccessCopyWithImpl;
  @override
  @useResult
...
class HttpResultError extends HttpResult {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $HttpResultErrorCopyWith<HttpResultError> get copyWith =>
      _$HttpResultErrorCopyWithImpl<HttpResultError>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is HttpResultError &&
            (identical(other.uri, uri) || other.uri == uri) &&
...
/// @nodoc
abstract mixin class $HttpResultErrorCopyWith<$Res>
    implements $HttpResultCopyWith<$Res> {
  factory $HttpResultErrorCopyWith(
          HttpResultError value, $Res Function(HttpResultError) _then) =
      _$HttpResultErrorCopyWithImpl;
  @override
  @useResult
...
mixin _$HttpError {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is HttpError);
  }
...
extension HttpErrorPatterns on HttpError {
  ...
  TResult maybeMap<TResult extends Object?>({
    ...
    switch (_that) {
      ...
      case _HttpErrorNetworkError() when connectionFailed != null:
        return connectionFailed(_that);
      case _HttpErrorServerBusy() when retryLater != null:
        return retryLater(_that);
      case _HttpErrorUnknown() when unknownError != null:
  ...
  TResult map<TResult extends Object?>({
    ...
    switch (_that) {
      case _HttpErrorTimeout():
        return timeout(_that);
      case _HttpErrorNetworkError():
        return connectionFailed(_that);
      case _HttpErrorServerBusy():
        return retryLater(_that);
      case _HttpErrorUnknown():
        return unknownError(_that);
      case _:
        throw StateError('Unexpected subclass');
    }
  ...
  TResult maybeWhen<TResult extends Object?>({
    ...
    switch (_that) {
      case _HttpErrorTimeout() when timeout != null:
        return timeout();
      case _HttpErrorNetworkError() when connectionFailed != null:
        return connectionFailed(_that.errorMessage);
      case _HttpErrorServerBusy() when retryLater != null:
        return retryLater(_that.statusCode, _that.response);
      case _HttpErrorUnknown() when unknownError != null:
        return unknownError(_that.statusCode, _that.response);
      case _:
        return orElse();
    }
  }
...
class _HttpErrorTimeout extends HttpError {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is _HttpErrorTimeout);
  }
...
class _HttpErrorNetworkError extends HttpError {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$HttpErrorNetworkErrorCopyWith<_HttpErrorNetworkError> get copyWith =>
      __$HttpErrorNetworkErrorCopyWithImpl<_HttpErrorNetworkError>(
          this, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _HttpErrorNetworkError &&
...
/// @nodoc
abstract mixin class _$HttpErrorNetworkErrorCopyWith<$Res>
    implements $HttpErrorCopyWith<$Res> {
  factory _$HttpErrorNetworkErrorCopyWith(_HttpErrorNetworkError value,
          $Res Function(_HttpErrorNetworkError) _then) =
      __$HttpErrorNetworkErrorCopyWithImpl;
  @useResult
...
class _HttpErrorServerBusy extends HttpError {
  const _HttpErrorServerBusy({required this.statusCode, required this.response})
      : super._();
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$HttpErrorServerBusyCopyWith<_HttpErrorServerBusy> get copyWith =>
      __$HttpErrorServerBusyCopyWithImpl<_HttpErrorServerBusy>(
          this, _$identity);
...
/// @nodoc
abstract mixin class _$HttpErrorServerBusyCopyWith<$Res>
    implements $HttpErrorCopyWith<$Res> {
  factory _$HttpErrorServerBusyCopyWith(_HttpErrorServerBusy value,
          $Res Function(_HttpErrorServerBusy) _then) =
      __$HttpErrorServerBusyCopyWithImpl;
  @useResult
...
class _HttpErrorUnknown extends HttpError {
  const _HttpErrorUnknown({required this.statusCode, required this.response})
      : super._();
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$HttpErrorUnknownCopyWith<_HttpErrorUnknown> get copyWith =>
      __$HttpErrorUnknownCopyWithImpl<_HttpErrorUnknown>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _HttpErrorUnknown &&
            (identical(other.statusCode, statusCode) ||
                other.statusCode == statusCode) &&
            (identical(other.response, response) ||
                other.response == response));
...
/// @nodoc
abstract mixin class _$HttpErrorUnknownCopyWith<$Res>
    implements $HttpErrorCopyWith<$Res> {
  factory _$HttpErrorUnknownCopyWith(
          _HttpErrorUnknown value, $Res Function(_HttpErrorUnknown) _then) =
      __$HttpErrorUnknownCopyWithImpl;
  @useResult
  $Res call({int statusCode, String response});
}
