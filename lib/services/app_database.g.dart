...
class $DbPreferencesTableTable extends DbPreferencesTable
    with TableInfo<$DbPreferencesTableTable, DbPreferencesRow> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $DbPreferencesTableTable(this.attachedDatabase, [this._alias]);
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'DbPreferences';
  @override
  VerificationContext validateIntegrity(
    Insertable<DbPreferencesRow> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
  ...
  @override
  DbPreferencesRow map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return DbPreferencesRow(
  ...
  @override
  $DbPreferencesTableTable createAlias(String alias) {
    return $DbPreferencesTableTable(attachedDatabase, alias);
  }
}

class DbPreferencesRow extends DataClass
    implements Insertable<DbPreferencesRow> {
  final String key;
  final String value;
  const DbPreferencesRow({required this.key, required this.value});
  @override
  Map<String, Expression> toColumns(bool nullToAbsent) {
    final map = <String, Expression>{};
  ...
  DbPreferencesTableCompanion toCompanion(bool nullToAbsent) {
    return DbPreferencesTableCompanion(key: Value(key), value: Value(value));
  }

  factory DbPreferencesRow.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  DbPreferencesRow copyWith({String? key, String? value}) =>
      DbPreferencesRow(key: key ?? this.key, value: value ?? this.value);
  DbPreferencesRow copyWithCompanion(DbPreferencesTableCompanion data) {
    return DbPreferencesRow(
  ...
  @override
  String toString() {
    return (StringBuffer('DbPreferencesRow(')
          ..write('key: $key, ')
          ..write('value: $value')
          ..write(')'))
        .toString();
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is DbPreferencesRow &&
          other.key == this.key &&
          other.value == this.value);
}

class DbPreferencesTableCompanion extends UpdateCompanion<DbPreferencesRow> {
  final Value<String> key;
  final Value<String> value;
  final Value<int> rowid;
  const DbPreferencesTableCompanion({
    this.key = const Value.absent(),
    this.value = const Value.absent(),
    this.rowid = const Value.absent(),
  });
  DbPreferencesTableCompanion.insert({
    required String key,
    required String value,
    this.rowid = const Value.absent(),
  }) : key = Value(key),
       value = Value(value);
  static Insertable<DbPreferencesRow> custom({
  ...
  DbPreferencesTableCompanion copyWith({
    Value<String>? key,
    Value<String>? value,
    Value<int>? rowid,
  }) {
    return DbPreferencesTableCompanion(
      key: key ?? this.key,
  ...
  @override
  String toString() {
    return (StringBuffer('DbPreferencesTableCompanion(')
          ..write('key: $key, ')
          ..write('value: $value, ')
          ..write('rowid: $rowid')
          ..write(')'))
...
abstract class _$AppDatabase extends GeneratedDatabase {
  ...
  late final $DbPreferencesTableTable dbPreferencesTable =
      $DbPreferencesTableTable(this);
...
typedef $$HiddenSuggestionsTableTableProcessedTableManager =
    ProcessedTableManager<
      ...
      PrefetchHooks Function()
    >;
typedef $$DbPreferencesTableTableCreateCompanionBuilder =
    DbPreferencesTableCompanion Function({
      required String key,
      required String value,
      Value<int> rowid,
    });
typedef $$DbPreferencesTableTableUpdateCompanionBuilder =
    DbPreferencesTableCompanion Function({
      Value<String> key,
      Value<String> value,
      Value<int> rowid,
...
class $$DbPreferencesTableTableFilterComposer
    extends Composer<_$AppDatabase, $DbPreferencesTableTable> {
  $$DbPreferencesTableTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$DbPreferencesTableTableOrderingComposer
    extends Composer<_$AppDatabase, $DbPreferencesTableTable> {
  $$DbPreferencesTableTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$DbPreferencesTableTableAnnotationComposer
    extends Composer<_$AppDatabase, $DbPreferencesTableTable> {
  $$DbPreferencesTableTableAnnotationComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$DbPreferencesTableTableTableManager
    extends
        RootTableManager<
          _$AppDatabase,
          ...
          $$DbPreferencesTableTableOrderingComposer,
          $$DbPreferencesTableTableAnnotationComposer,
          $$DbPreferencesTableTableCreateCompanionBuilder,
          $$DbPreferencesTableTableUpdateCompanionBuilder,
          (
            DbPreferencesRow,
            BaseReferences<
              _$AppDatabase,
          ...
          PrefetchHooks Function()
        > {
  $$DbPreferencesTableTableTableManager(
    _$AppDatabase db,
    $DbPreferencesTableTable table,
  ) : super(
        TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
              $$DbPreferencesTableTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () =>
              $$DbPreferencesTableTableOrderingComposer($db: db, $table: table),
          createComputedFieldComposer: () =>
              $$DbPreferencesTableTableAnnotationComposer(
                $db: db,
                $table: table,
...
typedef $$DbPreferencesTableTableProcessedTableManager =
    ProcessedTableManager<
      _$AppDatabase,
      $DbPreferencesTableTable,
      DbPreferencesRow,
...
class $AppDatabaseManager {
  ...
  $$DbPreferencesTableTableTableManager get dbPreferencesTable =>
      $$DbPreferencesTableTableTableManager(_db, _db.dbPreferencesTable);
}
