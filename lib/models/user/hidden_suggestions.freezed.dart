...
mixin _$HiddenSuggestions {
  ...
  @override
  String toString() {
    return 'HiddenSuggestions(locale: $locale, version: $version, lastUpdated: $lastUpdated, items: $items, categories: $categories)';
  }
}
...
extension HiddenSuggestionsPatterns on HiddenSuggestions {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String locale, int version, DateTime lastUpdated,
            List<String> items, List<String> categories)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _HiddenSuggestions() when $default != null:
        return $default(_that.locale, _that.version, _that.lastUpdated,
            _that.items, _that.categories);
      case _:
        return orElse();
    }
  }
...
class _HiddenSuggestions extends HiddenSuggestions {
  const _HiddenSuggestions(
      ...
      : _items = items,
        ...
        super._();
  factory _HiddenSuggestions.fromJson(Map<String, dynamic> json) =>
      _$HiddenSuggestionsFromJson(json);
  ...
  @override
  Map<String, dynamic> toJson() {
    return _$HiddenSuggestionsToJson(
      this,
    );
  }
