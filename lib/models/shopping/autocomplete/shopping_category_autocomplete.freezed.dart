...
mixin _$ShoppingCategoryAutocomplete {
  ...
  $ShoppingCategoryAutocompleteCopyWith<ShoppingCategoryAutocomplete>
      get copyWith => _$ShoppingCategoryAutocompleteCopyWithImpl<
              ShoppingCategoryAutocomplete>(
          this as ShoppingCategoryAutocomplete, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ShoppingCategoryAutocomplete &&
...
abstract mixin class $ShoppingCategoryAutocompleteCopyWith<$Res> {
  factory $ShoppingCategoryAutocompleteCopyWith(
          ...
          $Res Function(ShoppingCategoryAutocomplete) _then) =
      _$ShoppingCategoryAutocompleteCopyWithImpl;
  @useResult
  $Res call(
      {String name,
...
extension ShoppingCategoryAutocompletePatterns on ShoppingCategoryAutocomplete {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ShoppingCategoryAutocomplete value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String name, ShoppingCategoryAutocompleteSource source,
            String sourceId)?
        $default, {
    required TResult orElse(),
  }) {
    ...
    switch (_that) {
      case _ShoppingCategoryAutocomplete() when $default != null:
        return $default(_that.name, _that.source, _that.sourceId);
      case _:
        return orElse();
    }
  }
...
class _ShoppingCategoryAutocomplete extends ShoppingCategoryAutocomplete {
  const _ShoppingCategoryAutocomplete(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ShoppingCategoryAutocompleteCopyWith<_ShoppingCategoryAutocomplete>
      get copyWith => __$ShoppingCategoryAutocompleteCopyWithImpl<
          _ShoppingCategoryAutocomplete>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _ShoppingCategoryAutocomplete &&
            (identical(other.name, name) || other.name == name) &&
            (identical(other.source, source) || other.source == source) &&
            (identical(other.sourceId, sourceId) ||
                other.sourceId == sourceId));
...
/// @nodoc
abstract mixin class _$ShoppingCategoryAutocompleteCopyWith<$Res>
    implements $ShoppingCategoryAutocompleteCopyWith<$Res> {
  factory _$ShoppingCategoryAutocompleteCopyWith(
          _ShoppingCategoryAutocomplete value,
          $Res Function(_ShoppingCategoryAutocomplete) _then) =
      __$ShoppingCategoryAutocompleteCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String name,
