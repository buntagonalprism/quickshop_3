...
/// to read the list.
///
/// Copied from [ListLeaveInProgressNotifier].
@ProviderFor(ListLeaveInProgressNotifier)
final listLeaveInProgressNotifierProvider = AutoDisposeNotifierProvider<
    ListLeaveInProgressNotifier, Set<ListId>>.internal(
  ListLeaveInProgressNotifier.new,
  name: r'listLeaveInProgressNotifierProvider',
  debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
      ? null
      : _$listLeaveInProgressNotifierHash,
  dependencies: null,
  allTransitiveDependencies: null,
);

typedef _$ListLeaveInProgressNotifier = AutoDisposeNotifier<Set<ListId>>;
